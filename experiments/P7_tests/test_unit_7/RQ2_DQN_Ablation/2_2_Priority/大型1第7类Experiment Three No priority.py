...
# ========== 修改为新的取值范围 ==========
X_MIN, X_MAX = 1, 80    # 流量范围
Y_MIN, Y_MAX = 1, 120   # 电压范围
Z_MIN, Z_MAX = 1, 15    # 电流/密度范围
# =======================================
...
# ========== 将 execute_Tr 指向 section7 ==========
def execute_Tr(x, y, z):
    return section7_flow_pressure_density_hybrid(x, y, z)
