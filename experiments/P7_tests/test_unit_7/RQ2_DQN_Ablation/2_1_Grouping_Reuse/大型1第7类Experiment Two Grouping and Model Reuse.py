...
# === 全局取值范围配置（按您最后要求：X:1~80, Y:1~120, Z:1~15） ===
STATE_MIN_W, STATE_MAX_W = 1, 80     # 温度/压力
STATE_MIN_T, STATE_MAX_T = 1, 120    # 电压/压力
...
# ================== 规则函数 section7（已修正，删除无用 actions） ==================
