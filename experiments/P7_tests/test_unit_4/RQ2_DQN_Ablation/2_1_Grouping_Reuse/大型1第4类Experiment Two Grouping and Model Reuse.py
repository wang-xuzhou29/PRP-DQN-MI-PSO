...
# === 全局取值范围配置（按您最后要求：1~100, 1~100, 1~60） ===
STATE_MIN_W, STATE_MAX_W = 1, 100    # 温度/湿度
STATE_MIN_T, STATE_MAX_T = 1, 100    # 电压/时间
STATE_MIN_Z, STATE_MAX_Z = 1, 60     # 流量/电流
# === / ===
