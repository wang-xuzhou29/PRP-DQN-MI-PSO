...
# ========== 修改为新的取值范围 ==========
X_MIN, X_MAX = 20.0, 80.0      # 流量 (L/min)
Y_MIN, Y_MAX = 200.0, 250.0    # 电压 (V)
Z_MIN, Z_MAX = 4.0, 20.0       # 电流 (A)
# =======================================
...
# ========== section3 规则函数（热-电-流混合控制） ==========
def section3_thermal_electrical_flow_hybrid(x, y, z):
    """第3类: 热-电-流混合控制 (流量x, 电压y, 电流z) - 104个分支"""
    triggered = set()
    ...
    # 第6组: 三参数复合条件 (分支19-22)
    if (x > 58 and x < 72 and y > 223 and y < 237 and z > 10.5 and z < 14.5) != (x > 68 and x < 72 and y > 223 and y < 237 and z > 10.5 and z < 14.5): triggered.add(19)
    if (x > 58 and x < 72 and y > 223 and y < 237 and z > 10.5 and z < 14.5) != (x > 48 and x < 72 and y > 223 and y < 237 and z > 10.5 and z < 14.5): triggered.add(20)
    if (x > 58 and x < 72 and y > 223 and y < 237 and z > 10.5 and z < 14.5) != (x > 58 and x < 72 and y > 233 and y < 237 and z > 10.5 and z < 14.5): triggered.add(21)
    if (x > 58 and x < 72 and y > 223 and y < 237 and z > 10.5 and z < 14.5) != (x > 58 and x < 72 and y > 223 and y < 227 and z > 10.5 and z < 14.5): triggered.add(22)
...
# ========== execute_Tr 指向 section3 ==========
def execute_Tr(x, y, z):
    return section3_thermal_electrical_flow_hybrid(x, y, z)
...
def generate_samples_for_similar_paths(similar_group_indices, num_total=2000, top_k=200):
    ...
    for path_idx in similar_group_indices:
        ...
        while len(samples) < top_k and attempts < num_total * 5:
            attempts += 1
            state = (
                np.random.randint(int(X_MIN), int(X_MAX) + 1),
                np.random.randint(int(Y_MIN), int(Y_MAX) + 1),
                np.random.randint(int(Z_MIN), int(Z_MAX) + 1)
            )
