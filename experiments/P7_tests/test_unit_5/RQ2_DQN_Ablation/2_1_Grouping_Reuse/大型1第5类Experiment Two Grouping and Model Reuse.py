...
# === 全局取值范围配置（匹配 category5） ===
STATE_MIN_W, STATE_MAX_W = 1, 250    # x: 光照/温度
STATE_MIN_T, STATE_MAX_T = 1, 200    # y: 电压/扭矩
STATE_MIN_Z, STATE_MAX_Z = 1, 5      # z: 流量/电流因子
# === / ===
...
# ======================== 关键修正：execute_Tr 指向 category5 ========================
execute_Tr = category5_multivariable_control


# === 目标路径组（为 category5 设计） ===
targetPaths = [
