...
# ========== 修改为新的取值范围 ==========
X_MIN, X_MAX = 1, 250    # 温度/光照范围
Y_MIN, Y_MAX = 1, 200    # 电压/温度范围
Z_MIN, Z_MAX = 1, 5      # 流量/电流范围
# =======================================
...
# ========== category5 规则函数（修复返回值，仅返回 triggered） ==========
def category5_multivariable_control(x, y, z):
    ...
    return triggered   # 只返回触发集合


# ========== execute_Tr 指向 category5 ==========
def execute_Tr(x, y, z):
    return category5_multivariable_control(x, y, z)
