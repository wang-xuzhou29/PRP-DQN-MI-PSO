...
# 1. 状态范围配置（按您的最新要求）
# ================================================================
STATE_MIN_X, STATE_MAX_X = 1, 65      # 温度/湿度
STATE_MIN_Y, STATE_MAX_Y = 100, 205   # 电压/扭矩
STATE_MIN_Z, STATE_MAX_Z = 1, 20      # 流量/电流

def generate_input():
    # 使用 randint 生成整数，因为 section10 规则大多为整数比较
    return [
