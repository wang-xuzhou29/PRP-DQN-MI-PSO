...
# === 配置（新范围：速度 140~240，扭矩 200~250，电流 1~90） ===
EXPERIMENT_CONFIG = {
    'STATE_DIM': 3,
    'ACTION_DIM': 3,
    'MIN_VALUES': np.array([140.0, 200.0, 1.0]),
    'MAX_VALUES': np.array([240.0, 250.0, 90.0]),
...
def train_ppo_workflow():
    print("=" * 80)
    print("PPO 训练 - 速度-扭矩-电流混合控制（section9）")
    print("状态范围: x(速度) 140~240, y(扭矩) 200~250, z(电流) 1~90")
...
def main():
    print("\n" + "=" * 80)
    print("PPO 多轮实验 - 速度-扭矩-电流混合控制（section9）")
    print("参数范围: 速度 140~240, 扭矩 200~250, 电流 1~90")
    print("=" * 80)
    ...
    output_path = f"PPO_section9_20run_{timestamp}.xlsx"
