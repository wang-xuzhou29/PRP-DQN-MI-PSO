...
import math  # 已导入，但为保险保留

# === device setup ===
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
os.environ["KMP_DUPLICATE_LIB_OK"] = "TRUE"

# === 全局取值范围配置（已按要求设置为：温度 1~300，电压 1~200，流量 1~5） ===
STATE_MIN_W, STATE_MAX_W = 1, 300   # 温度/湿度
STATE_MIN_T, STATE_MAX_T = 1, 200   # 电压/时间
STATE_MIN_Z, STATE_MAX_Z = 1, 5     # 流量/电流
# === / ===
