...
BOUNDS = {
    'light': (LIGHT_MIN, LIGHT_MAX),      # x: light intensity (2, 100)
    'temp': (TEMP_MIN, TEMP_MAX),          # y: temperature (1, 105)
    'moisture': (MOISTURE_MIN, MOISTURE_MAX)  # z: moisture (1, 110)
}
...
def generate_random_state():
    """生成随机状态: x(2,100), y(1,105), z(1,110)"""
...
def execute_Tr(state_or_x, y=None, z=None):
    ...
    执行目标函数，返回触发的分支集合。
    支持两种调用方式:
    - execute_Tr(position): position是3元素数组
    ...
    if y is None and z is None:
        ...
        y = int(np.clip(position[1], BOUNDS['temp'][0], BOUNDS['temp'][1]))
        z = int(np.clip(position[2], BOUNDS['moisture'][0], BOUNDS['moisture'][1]))
    else:
        # 分别传入x,y,z
        x = int(np.clip(state_or_x, BOUNDS['light'][0], BOUNDS['light'][1]))
        y = int(np.clip(y, BOUNDS['temp'][0], BOUNDS['temp'][1]))
        z = int(np.clip(z, BOUNDS['moisture'][0], BOUNDS['moisture'][1]))
    ...
    # --- 分支 37-54 ---
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x / (y + 0.001)) > 5 or (y / (z + 0.001) < 0.2)): b[36] = 37
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x / (y + 0.001)) > 5 and (y % (z + 0.001) < 0.2)): b[37] = 38
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x / (y + 0.001)) > 5 and (y / (z - 0.001) < 0.4)): b[38] = 39
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x / (y + 0.001)) > 5 and (y / (z + 0.001) < 0.3)): b[39] = 40
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x / (y + 0.001)) > 5 and (y / (z + 0.001) < 0.1)): b[40] = 41
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x / (y + 0.001)) > 8 and (y / (z + 0.001) < 0.2)): b[41] = 42
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x / (y + 0.001)) > 2 and (y / (z + 0.001) < 0.2)): b[42] = 43
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x / (y + 0.001)) > 1 and (y / (z + 0.001) < 0.2)): b[43] = 44
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x / (y + 0.001)) > 10 and (y / (z + 0.001) < 0.2)): b[44] = 45
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x * y / (y + 0.001)) > 5 and (y / (z + 0.001) < 0.2)): b[45] = 46
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x * x / (y + 0.001)) > 5 and (y / (z + 0.001) < 0.2)): b[46] = 47
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x / (y + 0.001)) > 5 and (y * x / (z + 0.001) < 0.2)): b[47] = 48
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x / (y + 0.001)) > 5 and (y * y / (z + 0.001) < 0.2)): b[48] = 49
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x / (y + 0.001)) > 5 and (y * z / (z + 0.001) < 0.2)): b[49] = 50
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x / (y + 0.001)) > 5 and (y / (z + 0.001) < 0.5)): b[50] = 51
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x / (y + 0.001)) > 5 and (y - (z + 0.001) < 0.2)): b[51] = 52
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x + (y + 0.001)) > 5 and (y / (z + 0.001) < 0.2)): b[52] = 53
    if ((x / (y + 0.001)) > 5 and (y / (z + 0.001)) < 0.2) != ((x - (y + 0.001)) > 5 and (y / (z + 0.001) < 0.2)): b[53] = 54

    # --- 分支 55-75 ---
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 20): b[54] = 55
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 12.9): b[55] = 56
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(20 - z) < 5): b[56] = 57
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - 80) > 10 and abs(x - z) < 5): b[57] = 58
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x + z) < 5): b[58] = 59
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 7): b[59] = 60
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 15 and abs(10 - z) < 10): b[60] = 61
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - 8) < 5): b[61] = 62
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - 2) < 5): b[62] = 63
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x * 4 - z) < 5): b[63] = 64
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x * z) < 5): b[64] = 65
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x + z) < 5): b[65] = 66
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x * y - z) < 5): b[66] = 67
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 2): b[67] = 68
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - y) < 5): b[68] = 69
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 15): b[69] = 70
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x * 2 - z) < 5): b[70] = 71
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(y - z) < 5): b[71] = 72
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x * z - z) < 5): b[72] = 73
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z * 2) < 5): b[73] = 74
    if (abs(x - y) > 10 and abs(y - z) > 10 and abs(x - z) < 5) != (abs(x - y) > 10 and abs(y - z) > 10 and abs(x * x - z) < 5): b[74] = 75

    # --- 分支 76-85 ---
    if ((x > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)) != ((x * x > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)): b[75] = 76
    if ((x > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)) != ((x * y > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)): b[76] = 77
    if ((x > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)) != ((x * z > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)): b[77] = 78
    if ((x > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)) != ((x > 90 or x < 5) and (y * y > 80 or y < 3) and (z > 75 or z < 2)): b[78] = 79
    if ((x > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)) != ((x > 90 or x < 5) and (y * z > 80 or y < 3) and (z > 75 or z < 2)): b[79] = 80
    if ((x > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)) != ((x > 90 or x < 5) and (y * x > 80 or y < 3) and (z > 75 or z < 2)): b[80] = 81
    if ((x > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)) != ((x * 10 > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)): b[81] = 82
    if ((x > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)) != ((x * 15 > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)): b[82] = 83
    if ((x > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)) != ((x > 50 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)): b[83] = 84
    if ((x > 90 or x < 5) and (y > 80 or y < 3) and (z > 75 or z < 2)) != ((x > 90 or x < 5) and (y > 80 or y < 3) and (z * 40 > 75 or z < 2)): b[84] = 85

    # --- 分支 86-100 ---
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((x * x) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2): b[85] = 86
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((x * 60) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2): b[86] = 87
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((y * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2): b[87] = 88
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((70 * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2): b[88] = 89
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((x * y) + (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2): b[89] = 90
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((x * y) / (z + 1) > 70 and x ** 2 + y ** 2 > z ** 2): b[90] = 91
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((x * y) / (z + 1) > 80 and x ** 2 + y ** 2 > z ** 2): b[91] = 92
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((x * y) / (z + 1) > 50 and x ** 1.5 + y ** 2 > z ** 2): b[92] = 93
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2.2): b[93] = 94
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2.5): b[94] = 95
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((x * y) / (z + 1) > 50 and x ** 2 + y ** 1.5 > z ** 2): b[95] = 96
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((x * y) / (z + 1) > 80 and x ** 2 + y ** 2 > z ** 2): b[96] = 97
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((x * y) / (z + 1) > 65 and x ** 2 + y ** 2 > z ** 2): b[97] = 98
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((x * y) / (z + 1) > 50 and x ** 1.2 + y ** 2 > z ** 2): b[98] = 99
    if ((x * y) / (z + 1) > 50 and x ** 2 + y ** 2 > z ** 2) != ((x * y) / (z + 1) > 50 and x ** 2 + y ** 1.2 > z ** 2): b[99] = 100
...
if __name__ == "__main__":
    ...
    print(f"Bounds: x(2,100), y(1,105), z(1,110)")
    print("=" * 100)
    if len(sys.argv) > 1:
        try:
