...
ACCESS_LEVEL_MIN, ACCESS_LEVEL_MAX = 1, 4   # 整数
...
def compute_robustness(state, path, sample_size=9):
    ...
    # 定义适合编排规则的邻域步长：
    # path_depth: +/-1, 0
    # file_count: 较大步长（如 +/-1000, +/-500, +/-100, 0）根据数据范围调整
    # access_level: +/-1, 0
    deltas = [
        (-1, -1000, -1), (0, -1000, 0), (1, -1000, 1),
        (-1, 0, -1), (1, 0, 1),
        (-1, 1000, -1), (0, 1000, 0), (1, 1000, 1),
        (0, 0, 0)
    ]
...
class DQNAgentWithPER:
    ...
    def decode_action(self, action_idx):
        ...
        针对编排规则设计的步长：
        - path_depth: 整数步长 [-5,-4,-3,-2,-1,0,1,2,3,4]
        - file_count: 大范围步长 [-5000,-4000,-3000,-2000,-1000,0,1000,2000,3000,4000]
        - access_level: 整数步长 [-2,-1,0,1,2] 重复两次以填满10个
        """
        # 为每个维度定义10个步长值
        step_lists = [
            [-5, -4, -3, -2, -1, 0, 1, 2, 3, 4],                         # path_depth
            [-5000, -4000, -3000, -2000, -1000, 0, 1000, 2000, 3000, 4000], # file_count
            [-2, -2, -1, -1, 0, 0, 1, 1, 2, 2]                            # access_level
        ]
...
def create_consolidated_excel_report(all_runs_data, similar_group, isolated_group, output_dir):
    ...
    output_path = os.path.join(output_dir, "20_runs_orchestration.xlsx")
    wb.save(output_path)
...
def run_20_times_training():
    model_path_base = r"D:\Experiment\CNN\DQNNEW\saved_models_orchestration"
    path_documents = r"D:\Experiment\CNN\DQNNEW\path_samples_individual"
    output_dir = r"D:\Experiment\CNN\ComparisonExperiment2\excel_reports_orchestration"
    ...
    print("=" * 60)
    print("20次运行 - 编排规则 (path_depth, file_count, access_level)")
